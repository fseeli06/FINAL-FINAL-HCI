...
label start:
    ...
    play sound "audio/cricket_sounds.mp3" volume 0.3
    scene stairs-night
    with Fade (0.3, 0.0, 0.3)
    show carl:
        xoffset -300
    ...
    hide carl
    stop sound
    play sound "audio/m_scream.mp3" noloop 
    scene black-screen
    pause 2.0
    stop sound
    play sound "audio/dead_thud.mp3" noloop
    scene black-screen
    pause 2.0
...
label movie:
    ...
    play music "audio/less_bg.mp3" fadein 0.5 volume 1.0
    scene belmont-house
    with Fade (0.0, 0.0, 0.3)

    play sound "audio/talking.mp3" fadein 0.5 volume 0.3 noloop
    show kid1:
        xoffset -300
    show kid2:
        xoffset 300
    ...
    play sound "audio/high_talking.mp3" fadein 0.5 volume 0.3 noloop
    ...
    play sound "audio/talking.mp3" fadein 0.2 volume 0.3 
    ...
    play audio "audio/leaves.mp3" fadein 1.0 fadeout 3.0 volume 0.4 noloop
    play music "audio/lake.mp3" volume 0.3
    scene lake_view
    with Fade (0.1, 0.0, 0.3)
    stop audio
    play sound "audio/high_talking.mp3" fadein 0.5 volume 0.3 noloop
    ...
    show daisy:
        xoffset 300
    play audio "audio/dog.mp3" volume 0.5 noloop
    "{i}arf arf{/i}"
    stop audio
    hide kid2
    hide daisy
    ...
    show kid1
    play sound "audio/talking.mp3" fadein 0.5 volume 0.3 noloop
    play audio "audio/galit_dog.mp3" noloop
    m "Okay okay, geez."
    stop sound
    hide kid1
    stop audio
    ...
    play audio "audio/hala.mp3" noloop
    scene dock-zoom
    pause 1.5
    stop audio 
    ...
    play music "audio/bg_music.mp3" volume 0.6 loop
...
label fb_glitch:
    play music "audio/full_fb.mp3" volume 0.3 fadeout 0.5
    ...
    scene black 
    with Fade(0.1, 0.0, 0.3)
    play sound "audio/heartbeat_suspense.mp3" fadein 0.5 volume 0.1 noloop
...
label shore:
    ...
    menu: 
        ...
        "I’m not the only “Morgan Lee”, Miller. Besides, it’s my first time here in this city. I was just here because of this case.":
            $ suspicion +=2
...
label escape:
    ...
    scene smoke
    with fade 
    play audio "audio/hiss.mp3" volume 0.2
    dm "DETECTIVE MORGAN"
    "MORGAN!"
    stop audio
    stop music
label end:
    play music "audio/bg_music.mp3" volume 1.0 loop
    scene black-screen
    with fade 
